...
import Connecting from "./Connectingflights";
...
export default function ShowTable() {
  ...
  const getallflight = () => {
    axios
      .get("https://airportauthority.herokuapp.com/allflights")
      .then((res) => {
  ...
  const handleSearchFlight = (event) => {
    ...
    axios
      .get(
        `https://airportauthority.herokuapp.com/flightbyname?startairport=${event.target.startairport.value}&endairport=${event.target.endairport.value}`
      )
      .then((res) => {
        console.log(res.data);
        dispatch(setProducts(res.data));
